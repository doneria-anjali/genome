...
def breakApart():
   df3 = pd.read_csv('resources/smallerweather2016.csv') 
   print(len(df3))
   ...
   df4 = pd.read_csv('resources/smallerweather2016.csv') 
   print(len(df4))
   ...
   df = pd.read_csv('resources/smallerweather2017.csv') 
   print(len(df))
   ...
   df2 = pd.read_csv('resources/smallerweather2017.csv') 
   print(len(df2))
